...
if(length(args)  != 5){
    ...
    folder_config_file          <-  "/home/ubuntu/Models/Hiding/Experiment_1/"
    config_file                 <-  "Hiding_urea_COG_BoW_pickone_genomes.dat"
    ...
    model_config_file           <-  "models_downSample.json"
                                    ...
                                    #"model.XGBoost.json"
    folder_output               <-  "/home/ubuntu/Models/Hiding/Experiment_1_results/"
